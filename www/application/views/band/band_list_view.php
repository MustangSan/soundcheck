   ...
   <div id="wrapper">
      ...
      <div id="page-wrapper">
         ...
         <div class="row">
               <!-- Page Header -->
               <div class="col-lg-12">
                  <h1 class="page-header">My Bands</h1>
               </div>
               <!--End Page Header -->
         </div>
         ...
         <div class="row">
            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                  Bands
                  <a class="create-btn btn btn-default btn-sm" style="float: right;" href="<?php echo base_url('bands/createBand'); ?>">
                     <i class="fa fa-music fa-fw"></i> Create Band
                  </a>
               </div>
                           ...
                           <?php 
                              if(!empty($bands))
                                 foreach ($bands as $key) {
                                    ...
                                    echo "<td><a href=\"".base_url('bands/editProfile/'.$key->getIdBand())."\">Edit Profile</a></td></tr>";
                                 }
                           ?>
                        </tbody>
                     </table>

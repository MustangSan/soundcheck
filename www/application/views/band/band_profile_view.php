         ...
         <div class="row">
            <div class="panel panel-default">
               <div class="panel-heading">
                  Profile
                  <a class="create-btn btn btn-primary btn-sm" style="float: right;" href="<?php echo base_url('bands/followBand/'.$band->getIdBand()); ?>">
                     <i class="fa fa-music fa-fw"></i> Follow <?php echo $band->getName();?>
                  </a>
               </div>
                  ...
                  <div style="margin-top: 15px;" class="row">
                     ...
                     <div class="col-lg-2 col-md-4">
                        <div class="panel panel-primary no-boder">
                           ...
                           <a href="<?php echo base_url('bands/members/'.$band->getIdBand()); ?>">
                     ...
                     <div class="col-lg-2 col-md-4">
                        <div class="panel panel-primary no-boder">
                           ...
                           <a href="<?php echo base_url('bands/albuns/'.$band->getIdBand()) ?>">
                              <div class="panel-footer">
                                 <span class="pull-left">More Details</span>
                                 <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                 <div class="clearfix"></div>
                     ...
                     <div class="col-lg-2 col-md-4">
                        <div class="panel panel-primary no-boder">
                           ...
                           <a href="<?php echo base_url('bands/shows/'.$band->getIdBand()); ?>">
                              <div class="panel-footer">
                                 <span class="pull-left">More Details</span>
                                 <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                 <div class="clearfix"></div>
                     ...
                     <div class="col-lg-2 col-md-4">
                        <div class="panel panel-primary no-boder">
                           ...
                           <a href="<?php echo base_url('bands/tours/'.$band->getIdBand()); ?>">
                              <div class="panel-footer">
                                 <span class="pull-left">More Details</span>
                                 <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                 <div class="clearfix"></div>
                     ...
                     <div class="col-lg-2 col-md-4">
                        <div class="panel panel-primary no-boder">
                           ...
                           <a href="<?php echo base_url('bands/blog/'.$band->getIdBand()); ?>">
                              <div class="panel-footer">
                                 <span class="pull-left">More Details</span>
                                 <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                 <div class="clearfix"></div>
